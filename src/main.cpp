...
int yearsOld(tm* inputTgl, tm* currentTgl)
{
    ...
    // sekarang kita akan mengecek, apakah sudah tahun ini sudah ulang tahun.
...
int monthsOld(tm* inputTgl, tm* currentTgl)
{
    int yearsDiff = currentTgl->tm_year - inputTgl->tm_year;
    int monthsDiff = currentTgl->tm_mon - inputTgl->tm_mon;
